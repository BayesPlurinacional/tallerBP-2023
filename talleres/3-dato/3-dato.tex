...
\only<2>{
\begin{textblock}{100}(60,24)
$P(\text{Diagnóstico}|\text{Estado})$ \\[0.3cm]

\begin{tabular}{|c|c|c|} \hline  \setlength\tabcolsep{0.4cm}
 & D = Positivo & D = Negativo\\ \hline
E = Verdadero & Sensibilidad & 1-Sensibilidad \\ \hline
E = Falso     & 1-Especificidad & Especificidad \\ \hline
  \end{tabular}
\end{textblock}
}
...
\begin{tikzpicture}[scale=0.33]
    ...
    \node[factor, below=of p] (fe) {};
    \node[const, left=of fe] (nfe) {Bernoulli$(p_c)$};
    \node[latent, below=of fe] (e) {$e_i$};
    \node[factor, right=of e] (fr) {};
    \gate {if} {(fr)} {};
    \node[latent, below=of fr] (r) {$r_{it}$};
    \node[invisible, below=of r, yshift=-0.4cm] (ir) {};
    \node[invisible, left=of fr, xshift=-0.4cm] (ifr) {};
    \node[latent, right=of fr] (s) {$s_{ot}$};
    \node[factor, right=of s] (fs) {};
    \node[const, above=of fs] (nfs) {Beta$(\cdot,\cdot)$};
    \node[invisible, above=of nfs, xshift=0.8cm, yshift=0.1cm] (infs) {};
    ...
    \plate {individuo} {(nfe)(e)(r)(fr)(ir)} {$i:$ Individuo}; %
    \plate {comunidad} {(nfp)(nfe)(fp)(p)(r)(e)(individuo)} {$c:$ Comunidad};
    \plate {opciones} {(fr)(s)(nfs)(if)} {$o:$ Clase}; %%
    \plate {test} {(r)(fr)(s)(nfs)(ifr)(infs)} {$t:$ Test}; %%
\end{tikzpicture}
}
\end{textblock}
}
