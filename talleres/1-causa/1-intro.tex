...
\centering \Large
¿Cuánto más sé, menos información recibo?
\end{textblock}
}
...
\begin{textblock}{160}(0,48)
\centering \Large
¿Puedo dar más información a una niña o a una experta?
\end{textblock}
}
...
\only<3>{
\includegraphics[page=1,width=\textwidth]{figuras/probaOfWin_2D}
}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.65\textwidth}
       \includegraphics[page=1,width=\textwidth]{figuras/probaOfWin}
     \end{subfigure}
\end{figure}
}
