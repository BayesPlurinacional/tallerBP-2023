...
\end{frame}
 ...
 \begin{frame}[plain]
\begin{textblock}{160}(0,4)
 \centering \LARGE Buenos y malos controles \\
 \end{textblock}
 \vspace{0.75cm}
...
% \only<2->{
% \begin{textblock}{130}(40,16) \normalsize \centering
% $y \sim w_0 + w_1 x + w_2 z^2$
%
% \includegraphics[width=0.70\textwidth]{figuras/pdf/controles-modelo1.pdf}
% \end{textblock}
% }
...
\begin{textblock}{160}(0,24) \centering
 \tikz{
    \node[det] (m) {$m$} ; %
    \node[latent, right=of m] (d) {$d$} ; %
    \node[det, right=of d,yshift=1.5cm] (o) {$o$} ; %
    \node[latent, right=of d,yshift=-1.5cm] (s) {$s$} ; %
    \node[latent, right=of d, xshift = 1.8cm] (a) {$a$} ;
